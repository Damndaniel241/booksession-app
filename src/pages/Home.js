...
function Home() {
  ...
  const [dpt, setDpt] = useState([])
    ...
    const onSuccess = (reference) => {
      ...
      axios.post("https://damndaniel241.pythonanywhere.com/appointment/", {
      name,
      email,
      chosen_time,
      dpt:option,
  ...
  function handleSubmit(e){
    ...
    let chosen_time = data.get("chosen_time")
    ...
    if (opinion == true){
      ...
      alert("oh! why change of mind? you can always count on us")
    }
        ...
        <div className="row align-items-center gap-5 gap-md-0">
          ...
          <div className="col-md-4 col-12 bg-white rounded-5">
            ...
            <form onSubmit={(e) => handleSubmit(e)} >
              ...
              <div className="my-3">
                <input type="datetime-local" name="chosen_time" className='form-control'/>
               
              
              </div>

                    <button className="btn btn-md btn-primary d-block m-auto mb-3 " name="submit">Book Appointment</button>
